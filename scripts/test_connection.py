...
def test_connection():
    ...
    if auth_type == "basic":
        ...
        if (
            ...
            print(
                "Please update the SERVICENOW_USERNAME and SERVICENOW_PASSWORD in your .env file."
            )
            sys.exit(1)
