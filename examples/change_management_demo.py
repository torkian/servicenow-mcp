...
def main():
    ...
    task1_params = {
        ...
        "planned_end_date": (
            datetime.strptime(start_date, "%Y-%m-%d %H:%M:%S") + timedelta(minutes=30)
    ...
    task2_params = {
        ...
        "planned_end_date": (
            datetime.strptime(start_date, "%Y-%m-%d %H:%M:%S") + timedelta(minutes=90)
        ).strftime("%Y-%m-%d %H:%M:%S"),
    }
    ...
    task3_params = {
        ...
        "planned_end_date": (
            datetime.strptime(start_date, "%Y-%m-%d %H:%M:%S") + timedelta(minutes=120)
        ).strftime("%Y-%m-%d %H:%M:%S"),
    }
